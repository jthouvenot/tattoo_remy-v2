...
<div class="large-12 columns columns" style="text-align:center;padding-bottom:60px;">
	<p style="font-weight;display:inline-block;margin-top:30px;margin-bottom:20px;color:#fff;">Retrouvez toutes nos photos sur</p><br/>
	<a target="_blank" href="https://www.facebook.com/pg/Remy-Tattoo-Etampes-174038515956778/photos/?ref=page_internal" style="color:#fff"><img id="img-facebook" src="./img/img-facebook-petit.png" alt="logo facebook" /></a>
